...
class Exante:
    def __init__(self, appid: str, clientid: str, sharedkey: str,  accountid: str, demo: bool=False) -> None:
        self._api = HTTPApi(auth=AuthMethods.JWT, appid=appid, clientid=clientid, sharedkey=sharedkey, ttl=86400, url=API_URI_DEMO if demo else API_URI_LIVE, log_level=logging.ERROR)
    ...
    def is_valid_symbol(self, sym: str) -> bool:
        return self._api.get_symbol(sym) is not None