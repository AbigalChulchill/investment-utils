...
# python bots_demo.py --strategy=DCAQuotaMultMAPeriod --strategy-args=dca_base_quota=100,ma_period=0 --sym=bitcoin --backtest --pnl --account=1000000 --tf=1d --start=2017-09-01 --end=2021-09-01 > $reports_dir/period0.txt
# python bots_demo.py --strategy=DCAQuotaMultMAPeriod --strategy-args=dca_base_quota=100,ma_period=20 --sym=bitcoin --backtest --pnl --account=1000000 --tf=1d --start=2017-09-01 --end=2021-09-01 > $reports_dir/period20.txt
# python bots_demo.py --strategy=DCAQuotaMultMAPeriod --strategy-args=dca_base_quota=100,ma_period=50 --sym=bitcoin --backtest --pnl --account=1000000 --tf=1d --start=2017-09-01 --end=2021-09-01 > $reports_dir/period50.txt
# python bots_demo.py --strategy=DCAQuotaMultMAPeriod --strategy-args=dca_base_quota=100,ma_period=100 --sym=bitcoin --backtest --pnl --account=1000000 --tf=1d --start=2017-09-01 --end=2021-09-01 > $reports_dir/period100.txt
# python bots_demo.py --strategy=DCAQuotaMultMAPeriod --strategy-args=dca_base_quota=100,ma_period=200 --sym=bitcoin --backtest --pnl --account=1000000 --tf=1d --start=2017-09-01 --end=2021-09-01 > $reports_dir/period200.txt
