...
# python bots_demo.py --strategy=DCA_ConstQuota           --strategy-args=dca_base_quota=100                              --sym=bitcoin --backtest --pnl --account=1000000 --tf=1d --start=2021-01-01 --end=2021-09-20 > $reports_dir/dcaquota1.txt
# python bots_demo.py --strategy=DCA_QuotaFromBasePrice   --strategy-args=dca_base_quota=100,dca_base_price=28000         --sym=bitcoin --backtest --pnl --account=1000000 --tf=1d --start=2021-01-01 --end=2021-09-20 > $reports_dir/dcaquotamult.txt

# backtesting MA length
# python bots_demo.py --strategy=DCA_QuotaFromSlowSMA --strategy-args=dca_base_quota=100,ma_period=0 --sym=bitcoin --backtest --pnl --account=1000000 --tf=1d --start=2017-09-01 --end=2021-09-01 > $reports_dir/0_period0.txt
# python bots_demo.py --strategy=DCA_QuotaFromSlowSMA --strategy-args=dca_base_quota=100,ma_period=20 --sym=bitcoin --backtest --pnl --account=1000000 --tf=1d --start=2017-09-01 --end=2021-09-01 > $reports_dir/0_period20.txt
# python bots_demo.py --strategy=DCA_QuotaFromSlowSMA --strategy-args=dca_base_quota=100,ma_period=50 --sym=bitcoin --backtest --pnl --account=1000000 --tf=1d --start=2017-09-01 --end=2021-09-01 > $reports_dir/0_period50.txt
# python bots_demo.py --strategy=DCA_QuotaFromSlowSMA --strategy-args=dca_base_quota=100,ma_period=100 --sym=bitcoin --backtest --pnl --account=1000000 --tf=1d --start=2017-09-01 --end=2021-09-01 > $reports_dir/0_period100.txt
# python bots_demo.py --strategy=DCA_QuotaFromSlowSMA --strategy-args=dca_base_quota=100,ma_period=200 --sym=bitcoin --backtest --pnl --account=1000000 --tf=1d --start=2017-09-01 --end=2021-09-01 > $reports_dir/0_period200.txt
